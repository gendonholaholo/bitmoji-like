...
SEBUM_TEXTS = {
    ...
    "IV": {
        ...
        "recommendations": ["Gel cleanser dengan salicylic acid", "Oil-free moisturizer", "Mattifying primer", "Chemical exfoliant BHA"]
    },
    "V": {
        ...
        "recommendations": ["Konsultasi dermatolog", "Retinoid topikal", "Deep cleansing treatment", "Sebum-regulating serum"]
    }
}
...
PORE_TEXTS = {
    ...
    "IV": {
        ...
        "recommendations": ["Retinol serum", "Professional facial treatment", "Pore-refining toner", "Salicylic acid cleanser"]
    },
    "V": {
        ...
        "recommendations": ["Konsultasi dermatolog", "Laser treatment", "Intensive pore treatment", "Medical-grade retinoid"]
    }
}
...
FLEK_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["Arbutin serum", "Vitamin C treatment", "Brightening mask", "SPF 50+ sunscreen"]
    },
    "IV": {
        ...
        "recommendations": ["Hydroquinone (konsultasi dokter)", "Chemical peel", "Tranexamic acid serum", "Azelaic acid"]
    },
    "V": {
        ...
        "recommendations": ["Konsultasi dermatolog", "Laser treatment", "Prescription depigmenting agents", "Professional peel"]
    }
}
...
WRINKLE_TEXTS = {
    ...
    "II": {
        ...
        "recommendations": ["Retinol serum", "Hyaluronic acid", "Facial massage", "Anti-aging moisturizer"]
    },
    "III": {
        ...
        "recommendations": ["Retinol 0.5%", "Collagen-boosting serum", "Eye cream dengan peptide", "Weekly mask treatment"]
    },
    "IV": {
        ...
        "recommendations": ["Prescription retinoid", "Professional treatment", "Intensive anti-aging serum", "Collagen supplements"]
    },
    "V": {
        ...
        "recommendations": ["Konsultasi aesthetic doctor", "Injectable treatments", "Laser resurfacing", "Medical-grade retinoid"]
    }
}
...
ACNE_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["Benzoyl peroxide", "AHA/BHA exfoliant", "Anti-bacterial treatment", "Non-comedogenic sunscreen"]
    },
    "IV": {
        ...
        "recommendations": ["Prescription acne treatment", "Adapalene gel", "Antibacterial wash", "Professional facial"]
    },
    "V": {
        ...
        "recommendations": ["Konsultasi dermatolog segera", "Oral medication", "Professional acne treatment", "Isotretinoin (jika direkomendasikan)"]
    }
}
...
KOMEDO_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["BHA exfoliant", "Retinol serum", "Deep pore cleanser", "Professional extraction"]
    },
    "IV": {
        ...
        "recommendations": ["Prescription retinoid", "Professional facial", "Salicylic acid peel", "Niacinamide serum"]
    },
    "V": {
        ...
        "recommendations": ["Dermatologist consultation", "Medical extraction", "Intensive pore treatment", "Prescription topicals"]
    }
}
...
DARK_CIRCLE_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["Vitamin C eye treatment", "Retinol eye cream", "Color-correcting concealer", "Adequate sleep"]
    },
    "IV": {
        ...
        "recommendations": ["Professional eye treatment", "Prescription lightening cream", "Under-eye filler (konsultasi)", "Iron supplements (jika diperlukan)"]
    },
    "V": {
        ...
        "recommendations": ["Medical consultation", "Laser treatment", "PRP treatment", "Filler treatment"]
    }
}
...
SKIN_TONE_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["Brightening serum", "Alpha arbutin", "Regular exfoliation", "High SPF sunscreen"]
    },
    "IV": {
        ...
        "recommendations": ["Professional brightening treatment", "Tranexamic acid", "Kojic acid serum", "Retinoid"]
    },
    "V": {
        ...
        "recommendations": ["Dermatologist consultation", "Prescription depigmenting agents", "Laser treatment", "Chemical peel series"]
    }
}
...
SENSITIVITY_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["Soothing serum", "Barrier repair cream", "Gentle physical sunscreen", "Oat-based products"]
    },
    "IV": {
        ...
        "recommendations": ["Ultra-gentle cleanser", "Calming serum", "Hypoallergenic moisturizer", "Mineral sunscreen only"]
    },
    "V": {
        ...
        "recommendations": ["Dermatologist consultation", "Prescription-only products", "Thermal water spray", "Minimal skincare routine"]
    }
}
...
UV_SPOT_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["SPF 50+ daily", "Retinol at night", "Niacinamide", "Professional consultation"]
    },
    "IV": {
        ...
        "recommendations": ["Strict sun avoidance", "Prescription retinoid", "Chemical peel", "Laser treatment"]
    },
    "V": {
        ...
        "recommendations": ["Immediate dermatologist visit", "Skin cancer screening", "Medical-grade treatment", "Maximum sun protection"]
    }
}
...
PIGMENT_TEXTS = {
    ...
    "III": {
        ...
        "recommendations": ["Tranexamic acid", "Hydroquinone (short-term)", "Azelaic acid", "Chemical peel"]
    },
    "IV": {
        ...
        "recommendations": ["Professional peels", "Laser treatment", "Prescription depigmenting", "Combination therapy"]
    },
    "V": {
        ...
        "recommendations": ["Dermatologist consultation", "Combination laser therapy", "Oral tranexamic acid", "Long-term treatment plan"]
    }
}
...
COLLAGEN_TEXTS = {
    ...
    "II": {
        ...
        "recommendations": ["Collagen-boosting serum", "Hyaluronic acid", "Facial massage", "Antioxidants"]
    },
    "III": {
    ...
    "IV": {
        ...
        "recommendations": ["RF treatment", "HIFU", "Professional-grade retinoid", "Collagen supplements"]
    },
    "V": {
        ...
        "recommendations": ["Aesthetic consultation", "Thread lift", "Injectable treatments", "Intensive professional care"]
    }
}
